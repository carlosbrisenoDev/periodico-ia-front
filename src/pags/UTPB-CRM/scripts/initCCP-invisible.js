...
export default function (ccpContainerId) {
    ...
    const ccpUrl = "https://edav.my.connect.aws/connect/ccp-v2";
    ...
    try {
        connect.core.initCCP(
            ...
            softphone: {                    // optional, defaults below apply if not provided
                ...
                ringtoneUrl: "https://ecm.e-dav.net/media/ringtone.mp3" // optional, defaults to CCP’s default ringtone if a falsy value is set
            },
