...
class ImapDriver implements IDriver
{
	...
	{
		$ssl = $ssl ? '/ssl/novalidate-cert' : '/novalidate-cert';
	...
	public function appendMail($mailstring,$mailbox)
	{
		if(!imap_append($this->resource, $this->server . $mailbox,$mailstring)) {
			throw new DriverException("Cannot copy mail to '$mailbox': " . imap_last_error());
		}
	}
