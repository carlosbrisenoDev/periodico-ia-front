<html lang="es" slick-uniqueid="3"><head>
	...
	<title>API Incrementa CRM — Widgets</title>
...
<body cz-shortcut-listen="true">
        <form action="{{url('/api/client/web-form/')}}/57a0caf58c7cbda315f5def24f899d12" method="post" class="container" id="ClientWebFormForm" accept-charset="utf-8">
