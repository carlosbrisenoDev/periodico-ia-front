...
@section('content')
@php
    $reportes = \App\reportes_tickets::where('user_id',auth()->user()->id)
...
<div class=" mt-5">
    ...
    <div class="">
        <table class="table table-responsive table-stripped">
            ...
            <tbody>
                <tr class="cursor-pointer" onclick="window.location='{{ url('/mireporte/'.md5($reporte->id)) }}';">
...
{{-- <div class="content mt-5">
    <h4>Respuestas a mis reportes</h4>
    <div class="container"> --}}
        {{-- @foreach($reportes as $reporte) --}}
            {{-- <div class="card">
                <div class="card-header">
                ...
                <div class="card-body">
                    ...
                    <div class="card-text " x-data="{response:false}">
                        @if($reporte->estado ==0 || $reporte->estado ==1 || $reporte->estado ==2)
                            <a class="btn btn-light" x-on:click="response=!response">Responder</a>
                            <div class="card" x-show="response" style="position: absolute;z-index:5;">
                                <div class="card-body">
