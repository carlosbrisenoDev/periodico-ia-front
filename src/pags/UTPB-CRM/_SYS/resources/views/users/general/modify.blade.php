                      ...
                      <div class="col-md-4 pad15">
                        <div class="form-group{{ $errors->has('telefono') ? ' has-error' : '' }}">
                            <label for="telefono" class=" control-label">Teléfono</label>
                                ...
                                <input placeholder="Teléfono" disabled id="telefono" value="{{$ciudadano->telefono}}" type="text" class="form-control large" name="telefono"  autofocus>
                        ...
                        <div class="form-group{{ $errors->has('cp') ? ' has-error' : '' }}">
                            <label for="cp" class=" control-label">Código postal</label>
                                ...
                                <input placeholder="Código postal" disabled id="cp" value="{{$ciudadano->cp}}" type="text" class="form-control large" name="cp"  autofocus>
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <label for="email" class="control-label">Correo electrónico</label>
                                ...
                                <input placeholder="Correo electrónico" disabled id="email" value="{{$ciudadano->email}}" type="email" class="form-control large" name="email" required>
                        ...
                        <div class="form-group{{ $errors->has('localidad') ? ' has-error' : '' }}">
                            <label for="localidad" class=" control-label">Localidad</label>
                                ...
                                <input placeholder="Localidad" disabled id="localidad" type="text" value="{{$ciudadano->localidad}}" class="form-control large" name="localidad" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('colonia') ? ' has-error' : '' }}">
                            <label for="colonia" class=" control-label">Colonia</label>
                                ...
                                <input placeholder="Colonia" disabled id="colonia" value="{{$ciudadano->colonia}}" type="text" class="form-control large" name="colonia"  autofocus>
                      ...
                      <div class="col-md-4 pad15">
                        ...
                        <div class="form-group{{ $errors->has('numero') ? ' has-error' : '' }}">
                            <label for="numero" class=" control-label">Número</label>
                                ...
                                <input placeholder="Número" disabled id="numero" type="text" value="{{$ciudadano->numero}}" class="form-control large" name="numero" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('numeroint') ? ' has-error' : '' }}">
                            <label for="numeroint" class=" control-label">Número int.</label>
                                ...
                                <input placeholder="Número int." disabled id="numeroint" type="text" value="{{$ciudadano->numeroint}}" class="form-control large" name="numeroint" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('direccion') ? ' has-error' : '' }}">
                            <label for="direccion" class="control-label">Dirección</label>
                                ...
                                <textarea placeholder="Dirección" disabled id="direccion" class="form-control large" name="direccion" >{{$ciudadano->direccion}}</textarea>
