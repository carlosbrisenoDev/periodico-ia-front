                ...
                <div class="card-body">
                  <div class="clearfix">
                    ...
                    <div class="pull-right">
                      <a href="/juridico/fichatecnica" class="btn btn-primary"><i class="fa fa-plus"></i> Crear</a>
                    </div>
                  </div>
                  <hr>
                  @php
                    $max = 20;
                    $formatos  = \App\formato::where('level_id',Auth::user()->level->id)->where('tipo','0')->paginate($max);
                    $pull = "right";
                    $entrys = $formatos;
                    $where = "branding";
                    $nav = $entrys;
                    ...
                    <table class="table table-responsive">
                      ...
                      @foreach ($formatos as $id => $documento)
                        <tr>
                          ...
                          <td>{{"JUR-FT-".str_pad($documento->referencia, 4, "0", STR_PAD_LEFT)."/".Date("Y")}}</td>
