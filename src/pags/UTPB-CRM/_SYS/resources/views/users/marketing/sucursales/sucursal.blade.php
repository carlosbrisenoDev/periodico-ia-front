        ...
        <div class="col-md-12">
            <div class="card card-default large">
                <div class="card-body">
                        ...
                        <div class="col-12 col-md-12 col-lg-6">
                              <div class="{{ $errors->has('alias') ? ' has-error' : '' }}">
                                  <label for="alias" class="control-label">Alias</label>
                                      <input placeholder="Alias" required value="{{$sucursal->alias}}" id="alias" type="text" class="form-control large" name="alias" required autofocus>
                                      @if ($errors->has('alias'))
                                          <span class="help-block">
                        ...
                        <div class="col-12 col-md-12 col-lg-6">
                              ...
                              <div class="{{ $errors->has('estado') ? ' has-error' : '' }}">
                                  <label for="estado" class="control-label">Estado</label>
                                      ...
                                      <input placeholder="Estado" required value="{{$sucursal->estado}}" id="estado" type="text" class="form-control large" name="estado" required autofocus>
                      ...
                      <div class="col-12 col-md-12 col-lg-6">
                        <div class="row">
                          <div class="col-12 col-md-12 col-lg-6">
                            ...
                            <input placeholder="Longitud" value="{{$sucursal->lng}}" type="text" class="form-control large" name="lng" autofocus>
                          </div>
                          <div class="col-12 col-md-12 col-lg-6">
                            <label for="latitude" class="control-label">Latitud</label>
                            <input placeholder="Latitud"  value="{{$sucursal->lat}}" type="text" class="form-control large" name="lat" autofocus>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-12">
                        ...
                        <input type="checkbox" {{($sucursal->domicilio) ? "checked" : ""}} name="domicilio" value="1" id="domicilio">
                        <label for="domicilio">¿Habilitar para entregas a domicilio?</label>
                      </div>
                    </div>
                    <div class="col–12">
                      <hr>
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-12">
                        ...
                        <hr>
                        <label for="">Agregar franquiciatario</label>
                        <select class="form-control franquiciatario" name="franquiciatario_id">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-3">
                      <a class="btn btn-primary large" href="/sucursales/delete">
