                ...
                <div class="card-body">
                      ...
                      <div class="col-md-4 pad15">
                              ...
                              <div class="form-group{{ $errors->has('nombre') ? ' has-error' : '' }}">
                                  <label for="name" class=" control-label"> *Nombre(s)</label>
                                      ...
                                      <input placeholder="Nombre(s)" value="{{$ciudadano->nombre}}" required id="name" type="text" class="form-control large" name="nombre"  autofocus>
                              ...
                              <div class="form-group{{ $errors->has('apellidopat') ? ' has-error' : '' }}">
                                  <label for="apellidopat" class=" control-label">* Apellido paterno</label>
                                      ...
                                      <input placeholder="Apellido paterno" value="{{$ciudadano->apellidopat}}" required id="apellidopat" type="text" class="form-control large" name="apellidopat" autofocus>
                              ...
                              <div class="form-group{{ $errors->has('apellidomat') ? ' has-error' : '' }}">
                                  <label for="apellidomat" class=" control-label">* Apellido materno</label>
                                      ...
                                      <input placeholder="Apellido materno" value="{{$ciudadano->apellidomat}}" required id="apellidomat" type="text" class="form-control large" name="apellidomat"  autofocus>
                      ...
                      <div class="col-md-4 pad15">
                        ...
                        <div class="form-group{{ $errors->has('curp') ? ' has-error' : '' }}">
                            <label for="CURP" class=" control-label">CURP</label>
                                ...
                                <input placeholder="CURP" value="{{$ciudadano->curp}}" required id="CURP" type="text" class="form-control large" name="curp"  autofocus>
                        ...
                        <div class="form-group{{ $errors->has('numero') ? ' has-error' : '' }}">
                            <label for="numero" class=" control-label">Número</label>
                                ...
                                <input placeholder="Número" id="numero" type="text" value="{{$ciudadano->numero}}" class="form-control large" name="numero" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('numeroint') ? ' has-error' : '' }}">
                            <label for="numeroint" class=" control-label">Número int.</label>
                                ...
                                <input placeholder="Número int."id="numeroint" type="text" value="{{$ciudadano->numeroint}}" class="form-control large" name="numeroint" autofocus>
                    ...
                    <div class="col-md-12">
                      <hr>
                        ...
                        @if (Auth::user()->level->nombre == "Alcalde")
                          <div class="col-md-3">
