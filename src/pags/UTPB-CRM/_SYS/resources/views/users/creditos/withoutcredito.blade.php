        ...
        <div class="card-body">
          <div class="clearfix">
            <div class="float-start">
              ...
              <h6 class="card-subtitle mb-2 text-muted">Sin crédito</h6>
            </div>
            <div class="float-end">
          ...
          <hr>
            <table class="table table-sm table-striped table-hover">
              ...
              <tbody>
                @foreach (\App\cliente::doesntHave("cocredito")->where("status","4")->where("baja",NULL)->where("xmaterias",NULL)->where("nombre","not like","%PRUEBA%")->get() as $c)
                  <tr>
                    ...
                    <td>{{empty($c->telefono) ? "Sin tel." : $c->telefono}}</td>
            ...
            <table class="table table-sm table-striped table-hover">
              ...
              <tbody>
                @foreach (\App\cliente::doesntHave("cocredito")->where("status","4")->where("baja",NULL)->where("xmaterias",1)->where("nombre","not like","%PRUEBA%")->get() as $c)
                  <tr>
                    <td style="text-align:center;">
                      <a href="/ventas/cliente?cid={{md5($c->id)}}" data-bs-toggle="tooltip" data-bs-placement="top" title="Click para ver">
                        UOV-{{\Carbon\Carbon::parse($c->created_at)->format("Y")}}-{{$c->id}}
