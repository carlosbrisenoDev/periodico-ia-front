                ...
                <div class="card-body">
                  <div class="clearfix">
                    <div class="pull-left">
                      ...
                      @endphp
                      <h3><a href="/ciudadano/modifyc/{{md5($ciudadano->id)}}">{{$ciudadano->full_name()}}</a></h3>
                  ...
                  <hr>
                    ...
                    <div class="col-md-3">
                      ...
                      @if ($reporte->estado->nombre == "Finalizado")
                      <div class="form-group{{ $errors->has('procedio') ? ' has-error' : '' }}" style="color:red;">
                          <label for="name" class="control-label">¿Se ha cumplido de manera satisfactoria?</label>

                              <select requried class="form-control large" name="procedio">
                                  <option @if($reporte->procedio == 1) selected @endif value="1">Si</option>
                                  <option @if($reporte->procedio == 0) selected @endif value="0">No</option>
                              </select>
                    ...
                    <div class="col-md-12 nopadding">
                      ...
                      <div class="col-md-3">
                        <a href="/reportes/upload/{{md5($reporte->id)}}" type="submit" class="btn btn-success large">
                          <i class="fa fa-upload"></i>   Agregar documentos
                        </a>
                      </div>
                      <div class="col-md-3">
                        <a href="/reportes/notas/{{md5($reporte->id)}}" class="btn btn-success large">
                        <i class="fa fa-pencil"></i>    Notas
                      </a>
                      </div>
                      <div class="col-md-3">
                        <a target="_blank" href="/reportes/imprimir/{{md5($reporte->id)}}" class="btn btn-warning large">
