...
@section('content')
  ...
  <div class="row">
    <div class="col-12 col-md-6">
      <div class="row">
        <div class="col">
          <img src="{{ asset('images/empleados.jpg')}}" class="img">
        </div>
      </div>
    </div>
    <div class="col-12 col-md-6">
      <p class="justify gray">
        Regístrate con nosotros para ser cliente distinguido, facilita tu pedido a domicilio y obtén promociones exclusivas.
      </p>
      <div class="card  borderless">
        <div class="card-body">

          <form class="" action="/empleados/registro" method="post">
          <div class="form-row">
