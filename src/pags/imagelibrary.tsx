  ...
  return (
    <div className="layout dashboard-layout">
      ...
      <main className="content image-library-content">
        ...
        {!loading && !hasImages ? (
          <p className="image-library-info">Aun no hay imagenes en la biblioteca.</p>
        ) : null}

        {!loading && hasImages && viewMode === "grid" ? (
        ...
        {!loading && hasImages && viewMode === "list" ? (
          <div className="image-library-table-wrap">
            <table className="image-library-table">
              ...
              <tbody>
                {sortedImages.map((image) => (
                  <tr key={image.id}>
                    <td>
                      <img src={image.url} alt={image.filename} className="image-library-table-thumb" />
                    </td>
